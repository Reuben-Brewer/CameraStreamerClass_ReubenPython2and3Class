...
Verified working on: Python 3.12/13 for Windows 10/11 64-bit and Raspberry Pi Bullseye (Backend = "CAP_ANY", Camera = ELP USB).
'''
...
__version__ = "Software Revision J, 12/30/2025"

from .CameraStreamerClass_ReubenPython2and3Class import CameraStreamerClass_ReubenPython2and3Class
